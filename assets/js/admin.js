...
jQuery(document).ready(function ($) {
    ...
    $.wc_variation_images = {
        ...
        sortable: function () {
            $('.woocommerce_variation').each(function () {
                $(this).find('.wc-variation-images-image-list').sortable({
        ...
        update_variation: function ($list) {
            $($list).closest('.woocommerce_variation').addClass('variation-needs-update');
            $('.cancel-variation-changes, .save-variation-changes').removeAttr('disabled');
