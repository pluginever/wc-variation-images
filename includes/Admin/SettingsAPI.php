...
class SettingsAPI {
	 ...
	 *
	 * @param string $section Section array.
	 *
	 * @since 1.0.0
	 * @return mixed
	 */
	 ...
	 *
	 * @param array $args Fields attributes.
	 *
	 * @since 1.0.0
	 * @return string
	 */
	...
	/**
	 * Displays a select for a settings field.
	 *
	 * @param array $args Settings field args.
	 *
	 * @since 1.0.0
	...
	public function callback_file( $args ) {
		...
		$label = isset( $args['options']['button_label'] ) ? $args['options']['button_label'] : __( 'Choose File', 'wc-variation-images' );
