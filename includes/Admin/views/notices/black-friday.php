...
<div class="notice-body">
	<div class="notice-icon">
		<img src="<?php echo esc_attr( wc_variation_images()->get_assets_url( 'images/black-friday-icon.png' ) ); ?>" alt="Variation Images Black Friday Promo" />
	</div>
	<div class="notice-content">
		<h3>
			<?php esc_html_e( 'Black Friday Mega Sale! Get Flat 40% OFF on Variation Images Pro !!', 'wc-variation-images' ); ?>
		</h3>
		<p>
			<?php
			echo wp_kses_post(
				...
				/* translators: 1. Offer Percentage, 2. Coupon Code. */
					__( 'Unlock premium features at an unbeatable price this Black Friday! Enjoy %1$s on Variation Images Pro with code %2$s. Hurry, this deal ends soon!', 'wc-variation-images' ),
