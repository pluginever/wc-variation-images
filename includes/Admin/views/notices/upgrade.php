...
<div class="notice-body">
	...
	<div class="notice-content">
		...
		<p>
			...
			echo wp_kses_post(
				sprintf(
					// translators: %1$s: Variation Images Pro link, %2$s: Coupon code.
					...
					'<a href="https://pluginever.com/plugins/wc-variation-images-pro/?utm_source=plugin&utm_medium=notice&utm_campaign=flash-sale" target="_blank"><strong>Variation Images Pro</strong></a>',
