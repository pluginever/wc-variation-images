<?php
/**
 * WC Variation Images Ajax Class
 *
 *
...
class Ajax {
	...
	*/
	public function __construct() {
		add_action( 'wp_ajax_wc_variation_images_load_variation_images', array(__CLASS__, 'wc_variation_images_load_variation_images' ) );
		add_action( 'wp_ajax_nopriv_wc_variation_images_load_variation_images', array(__CLASS__, 'wc_variation_images_load_variation_images' ) );
	}

	/**
	 * Send variation images in single product page
	 *
	 * @since 1.0.0
	*/
	public static function wc_variation_images_load_variation_images() {
		...
		$image = self::wc_variation_images_get_variation_images( $product_id, $variation_id );
	 ...
	 * @return false|string
	 */
	public static function wc_variation_images_get_variation_images( $product_id, $variation_id ) {
		// when variation id not found replace product_id as variation_id
		if ( '' == $variation_id ) {
