...
trait HasPlugin
{
    ...
    {
        return $this->get_dir_path('assets/build/' . $file);
    }
    /**
     * Get assets url.
     *
    ...
    {
        return $this->get_dir_url('assets/build/' . $file);
    }
    /**
     * Get meta links.
     *
    ...
    public function get_plugin_meta_links()
    {
        ...
        if (!empty($this->get_docs_url())) {
            $links['docs'] = array('label' => __('Documentation', 'wc-variation-images'), 'url' => $this->get_docs_url());
        }
        if (!empty($this->get_support_url())) {
            $links['support'] = array('label' => __('Support', 'wc-variation-images'), 'url' => $this->get_support_url());
        }
        if (!empty($this->get_review_url())) {
            $links['review'] = array('label' => __('Review', 'wc-variation-images'), 'url' => $this->get_review_url());
        }
        /**
    ...
    public function get_plugin_action_links()
    {
        ...
        if (!empty($this->get_settings_url())) {
            $links['settings'] = array('label' => __('Settings', 'wc-variation-images'), 'url' => $this->get_settings_url());
        }
        /**
